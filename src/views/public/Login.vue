...
<template>
  <MainLayout>
    <div class="max-w-md mx-auto">
      <div class="card">
        <h1 class="text-2xl font-bold text-white mb-6 text-center">Login to HandyHive</h1>
        ...
        <div class="mt-6 text-center">
          <p class="text-sm text-gray-400">
            ...
            <button @click="goToRegister" class="text-indigo-400 hover:text-indigo-300 font-medium ml-1">
              Sign up
            </button>
          </p>
        </div>
